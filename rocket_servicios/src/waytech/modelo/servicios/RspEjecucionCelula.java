 ...
 */
public class RspEjecucionCelula {
    ...
    private List<EjecucionCelula> todosLosEjecucionCelulas;
    ...
    private EjecucionCelula ejecucionCelula;

    public EjecucionCelula getEjecucionCelula() {
        return ejecucionCelula;
    }

    public void setEjecucionCelula(EjecucionCelula ejecucionCelula) {
        this.ejecucionCelula = ejecucionCelula;
    }
    ...
    public List<EjecucionCelula> getTodosLosEjecucionCelulas() {
        return todosLosEjecucionCelulas;
    }

    public void setTodosLosEjecucionCelulas(List<EjecucionCelula> todosLosEjecucionCelulas) {
        this.todosLosEjecucionCelulas = todosLosEjecucionCelulas;
    }
}
