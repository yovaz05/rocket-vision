 ...
 */
public class RspPlanificacionCelula {
    ...
    private List<PlanificacionCelula> todosLosPlanificacionCelulas;
    ...
    private PlanificacionCelula planificacionCelula;
    ...
    public PlanificacionCelula getPlanificacionCelula() {
        return planificacionCelula;
    }

    public void setPlanificacionCelula(PlanificacionCelula planificacionCelula) {
        this.planificacionCelula = planificacionCelula;
    }
    ...
    public List<PlanificacionCelula> getTodosLosPlanificacionCelulas() {
        return todosLosPlanificacionCelulas;
    }

    public void setTodosLosPlanificacionCelulas(List<PlanificacionCelula> todosLosPlanificacionCelulas) {
        this.todosLosPlanificacionCelulas = todosLosPlanificacionCelulas;
    }
}
