 ...
 */
public class RspPersonaEnCelula {
    ...
    private List<PersonaEnCelula> allPersonaEnCelulas;
    ...
    private PersonaEnCelula personaEnCelula;

    public List<PersonaEnCelula> getAllPersonaEnCelulas() {
        return allPersonaEnCelulas;
    }

    public void setAllPersonaEnCelulas(List<PersonaEnCelula> allPersonaEnCelulas) {
        this.allPersonaEnCelulas = allPersonaEnCelulas;
    }

    public PersonaEnCelula getPersonaEnCelula() {
        return personaEnCelula;
    }

    public void setPersonaEnCelula(PersonaEnCelula personaEnCelula) {
        this.personaEnCelula = personaEnCelula;
    }
