 ...
 */
public class RspPermisoTipoPersona {
    ...
    private List<PermisoTipoPersona> allPermisoTipoPersona;
    ...
    private PermisoTipoPersona permisoTipoPersona;
    ...
    public List<PermisoTipoPersona> getAllPermisoTipoPersona() {
        return allPermisoTipoPersona;
    }

    public void setAllPermisoTipoPersona(List<PermisoTipoPersona> allPermisoTipoPersona) {
        this.allPermisoTipoPersona = allPermisoTipoPersona;
    }

    public PermisoTipoPersona getPermisoTipoPersona() {
        return permisoTipoPersona;
    }

    public void setPermisoTipoPersona(PermisoTipoPersona permisoTipoPersona) {
        this.permisoTipoPersona = permisoTipoPersona;
    }
}
