 ...
 * @author Gabriel
 */
public class CtrlReporteCelulaListadoSemanaRed extends GenericForwardComposer {
...
//variable de control:
  ...
  String MENSAJE_NO_DATA = "Tu red no tiene células registradas";
    ...
    grid.setRowRenderer(new RowRenderer() {
      ...
      public void render(Row row, Object data) throws Exception {
        ...
        if (status == ReporteCelulaUtil.REPORTE_INGRESADO) {
          ...
          public void onEvent(Event event) throws Exception {
          //** TODO: mostrar mensaje("Sólo el líder directo de la célula puede ingresar su reporte");
          Sesion.setVariable("idCelula", idCelula);
