...
public class Sesion {
  ...
  public static boolean esLiderCelula() {
    return (Boolean) Sesion.getVariable("usuarioEsLiderCelula");
  }

  public static boolean esLiderRed() {
    return (Boolean) Sesion.getVariable("usuarioEsLiderRed");
  }
  public static boolean esAdministrador() {
    return (Boolean) Sesion.getVariable("usuarioAdministrador");
  }
}
