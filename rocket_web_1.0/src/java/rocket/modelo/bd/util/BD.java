...
public final class BD {
  ...
  public ArrayList<UsuarioUtil> usuarios;
  //variable reusable:
  ArrayList lista;
  ...
  public void crearUsuarios() {
    usuarios = new ArrayList<UsuarioUtil>();
    for (int i = 1; i < lideres.size(); i++) {
      LiderUtil lider = buscarLider(i);
      UsuarioUtil u = new UsuarioUtil(lider);
      int id = u.getId();
      //TODO: arreglar esto:
      if (id == 2) {
        u.setLogin("gabrielperez");
        u.setPassword("123");
        u.setTipo(UsuarioUtil.LIDER_RED);
      } else if (id == 3) {
        ...
        u.setPassword("123");
        u.setTipo(UsuarioUtil.LIDER_CELULA);
      } else if (id == 11) {
        u.setLogin("jcgodoy");
        u.setPassword("123");
        u.setTipo(UsuarioUtil.LIDER_RED);
        ...
        u.setPassword("123");
        u.setTipo(UsuarioUtil.ADMINISTRADOR_CELULAS);
      } else {
        continue;
      }
      usuarios.add(u);
  ...
  public ArrayList<UsuarioUtil> getUsuarios() {
    return usuarios;
  }
   ...
   */
  public UsuarioUtil buscarUsuario(String login) {
    for (UsuarioUtil u : usuarios) {
   ...
   * @return el objeto Usuario
   */
  public UsuarioUtil buscarUsuario(int id) {
    if (id == 0) {
      return null;//error
    }
    for (UsuarioUtil u : usuarios) {
   ...
   * @return el objeto Usuario
   */
  public UsuarioUtil buscarUsuario(String login, String password) {
